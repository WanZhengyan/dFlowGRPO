...
class EMAModuleWrapper:
    ...
    # Copy EMA parameters to the given parameters. If store_temp is True, also store the original parameters for later restoration.
    ...
    # Restore original parameters from temp storage. This should be called after copy_ema_to with store_temp=True.
